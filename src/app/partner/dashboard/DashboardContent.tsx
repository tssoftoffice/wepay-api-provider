        ...
        <div className={styles.container}>
            <header className={styles.header}>
                <div>
                    ...
                    <p className={styles.subtitle}>{t.dashboard.welcome}, {partner.storeName || 'Partner'}</p>
                </div>
            ...
            <div className={styles.statsGrid}>
                <Card className={styles.statCard}>
                    <div className={styles.statHeader}>
                        <span className={styles.statLabel}>{t.dashboard.walletBalance}</span>
                        <div className={styles.statIcon}>฿</div>
                    </div>
                    <div className={styles.statValue}>฿{Number(partner.walletBalance).toLocaleString()}</div>
                    <Link href="/partner/topup" className={styles.statLink}>{t.sidebar.topupCredit} →</Link>
                </Card>

                <Card className={styles.statCard}>
                    <div className={styles.statHeader}>
                        <span className={styles.statLabel}>{t.dashboard.subscription}</span>
                    ...
                    {partner.subscriptionStatus !== 'ACTIVE' && (
                        <Link href="/partner/subscription" className={styles.statLink}>{t.dashboard.renewNow} →</Link>
                    )}
                </Card>
                ...
                <Card className={styles.statCard}>
                    ...
                    <span className={styles.statSub}>{t.dashboard.todaysEarnings}</span>
                </Card>

                <Card className={styles.statCard}>
                    <div className={styles.statHeader}>
                        <span className={styles.statLabel}>{t.dashboard.activeGames}</span>
                    ...
                    <div className={styles.statValue}>0</div>
                    <Link href="/partner/pricing" className={styles.statLink}>{t.sidebar.manageGames} →</Link>
                </Card>
            </div>
